...
def rewrite_sao_jose():
    path = r"c:\Users\nazap\OneDrive\Área de Trabalho\projeto\Data Lake\Data Lake\docs\cidade-sao-jose-do-povo.md"
    
    with open(path, "r", encoding="utf-8") as f:
        content = f.read()

    new_content = """# Ficha do Município: São José do Povo

<link rel="stylesheet" href="../stylesheets/cidade.css">

<div class="dashboard-container" style="padding: 2rem;">
  <div class="cidade-container" style="margin-top: 20px;">
