...
<style>
  :root {
    --theme-color: #38bdf8; /* Azul claro (Ciano) da Saúde */
  }
</style>
...
<aside class="pbi-sidebar">
  ...
  <!-- Saúde -->
  <div class="pbi-nav-btn theme-saude active" title="Saúde" onclick="window.location.href='../saude/'" style="cursor:pointer;">
...
<div class="dashboard-container">
  ...
  <div class="kpi-grid">
    <div class="kpi-card">
      ...
      <span class="kpi-title">LEITOS DISPONÍVEIS</span>
      <h3 class="kpi-value">4.800</h3>
      <span class="kpi-trend">+3,4% vs. mês anterior</span>
    </div>
    <div class="kpi-card">
      <div class="kpi-icon">♡</div>
      <span class="kpi-title">ATENDIMENTOS/MÊS</span>
      <h3 class="kpi-value">24.000</h3>
      <span class="kpi-trend">+5,2% vs. mês anterior</span>
    </div>
    <div class="kpi-card">
      <div class="kpi-icon">💉</div>
      <span class="kpi-title">COBERTURA VACINAL</span>
      <h3 class="kpi-value">95%</h3>
      <span class="kpi-trend">+1,1% vs. mês anterior</span>
    </div>
    <div class="kpi-card">
      <div class="kpi-icon">⏳</div>
      <span class="kpi-title">TEMPO MÉDIO ESPERA</span>
      <h3 class="kpi-value">28min</h3>
      <span class="kpi-trend negative">-12% vs. mês anterior</span>
    </div>
  </div>

  <div class="charts-grid">
    <!-- Linha dupla: Atendimentos & Leitos -->
    <div class="chart-card">
      <div class="chart-header">
        <div>
          <div class="chart-title">Atendimentos & Leitos</div>
          <div class="chart-subtitle">Evolução mensal — Jan a Ago 2024</div>
        </div>
        <span class="chart-badge">Acumulado 2024</span>
      </div>
      <div class="chart-body">
        <canvas id="lineChartSaude"></canvas>
      </div>
    </div>
    ...
    <div class="chart-card">
      <div class="chart-header">
        <div>
          <div class="chart-title">Atendimentos por Unidade</div>
      ...
      <div class="chart-body" style="display: flex; align-items: center; justify-content: center;">
        <canvas id="donutChartSaude"></canvas>
      </div>
    </div>
  </div>
  ...
  <div class="charts-grid">
    ...
    <div class="chart-card">
      <div class="chart-header">
        <div>
          <div class="chart-title">Cobertura Vacinal por Mês (%)</div>
          <div class="chart-subtitle">Jan - Ago 2024</div>
        </div>
      </div>
      <div class="chart-body">
        <canvas id="barChartSaude"></canvas>
      </div>
    </div>
      ...
      <div class="alert-list">
        <div class="alert-item">
          <div class="alert-label">
            <span class="alert-icon ok">✓</span> Taxa de Ocupação de UTI
          </div>
          <div class="alert-meta">Meta: < 80% <span class="alert-value">72%</span></div>
        </div>
        <div class="alert-item">
          <div class="alert-label">
            <span class="alert-icon warn">⚠️</span> Mortalidade Infantil
          </div>
          <div class="alert-meta">Meta: < 10% <span class="alert-value" style="color:#f59e0b">12,3%</span></div>
        </div>
        <div class="alert-item">
          <div class="alert-label">
            <span class="alert-icon ok">✓</span> Cobertura de Saúde Básica
          </div>
          <div class="alert-meta">Meta: > 90% <span class="alert-value">95%</span></div>
        </div>
        <div class="alert-item">
          <div class="alert-label">
            <span class="alert-icon ok">✓</span> Médicos por 1.000 hab.
          </div>
          <div class="alert-meta">Meta: > 2,0 <span class="alert-value">2,1</span></div>
        </div>
        <div class="alert-item">
          <div class="alert-label">
            <span class="alert-icon warn">⚠️</span> Hospitais com ACCREDITATION
          </div>
          <div class="alert-meta">Meta: > 50% <span class="alert-value" style="color:#f59e0b">38%</span></div>
        </div>
      </div>
    </div>
  </div>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    // Line Chart
    new Chart(document.getElementById('lineChartSaude'), {
      type: 'line',
      data: {
        labels: ['Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago'],
        datasets: [{
          label: 'Atendimentos',
          data: [18000, 19000, 21000, 20500, 22000, 23500, 24000, 24000],
          borderColor: '#38bdf8',
          ...
          label: 'Leitos',
          data: [4200, 4200, 4300, 4300, 4400, 4600, 4800, 4800],
          borderColor: '#f59e0b',
          tension: 0.4
        }]
      },
    ...
    // Donut Chart
    new Chart(document.getElementById('donutChartSaude'), {
      type: 'doughnut',
      data: {
        labels: ['UBS', 'Hospital', 'UPA', 'Outros'],
        datasets: [{
          data: [45, 30, 15, 10],
          backgroundColor: ['#38bdf8', '#f59e0b', '#10b981', '#8b5cf6'],
          borderWidth: 0
        }]
      },
    ...
    // Bar Chart
    new Chart(document.getElementById('barChartSaude'), {
      type: 'bar',
      data: {
        labels: ['Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago'],
        datasets: [{
          data: [75, 78, 80, 82, 85, 88, 90, 95],
